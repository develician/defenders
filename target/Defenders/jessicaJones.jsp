...
<%
    ...
    ArrayList<String> srcLists = DAO.getSrcJessicaJones();
    ...
    <header class="header cf invert-links">
        <div class="container cf large">
            <div class="logo flat col one-four active"><span class="filter"><a
                    href="http://www.kristianhammerstad.com/#" data-filter="*"
                    style="color:#ffffff">Jessica Jones</a></span></div>
            <div class="menu cf">
                ...
                <ul class="flat col one-four">
                    ...
                    <li><a href="jessicaJonesUpload/uploadImages.jsp" style="color:#ffffff">Upload Images</a></li>
                </ul>
            </div>
        </div>
            ...
            <div class="isotope" style="position: relative; height: 10522.3px;">
                ...
                <div class="col one-four box illustration image-box" style="">
                    <figure class="thumb">
                        <a
                                href="#"
                                alt-src="../upload/jessicaJones/<%=srcLists.get(i)%>"
                                data-large="../upload/jessicaJones/<%=srcLists.get(i)%>"
                                data-large-size="1496x1800"
                                data-medium="../upload/jessicaJones/<%=srcLists.get(i)%>"
                                data-medium-size="897.6x1080"
                                data-small="../upload/jessicaJones/<%=srcLists.get(i)%>"
                                data-small-size="598.4x720"><img
                                src="../upload/jessicaJones/<%=srcLists.get(i)%>"
                                data-srcset="../upload/jessicaJones/<%=srcLists.get(i)%> 960w, ../upload/jessicaJones/<%=srcLists.get(i)%> 768w, ../upload/jessicaJones/<%=srcLists.get(i)%> 480w"
                                alt-src="../upload/jessicaJones/<%=srcLists.get(i)%>"
