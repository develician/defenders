    ...
    <header class="header cf invert-links">
        <div class="container cf large">
            <div class="logo flat col one-four active"><span class="filter"><a
                   style="color:#ffffff" href="http://www.kristianhammerstad.com/#" data-filter="*">Dare Devil</a></span></div>
            <div class="menu cf">
                ...
                <ul class="flat col one-four">
                    ...
                    <li class="filter"><a href="http://www.kristianhammerstad.com/#information" style="color:#ffffff"
                                          data-filter=".information">Information</a></li>
                    <li><a href="dareDevilUpload/uploadImages.jsp" style="color:#ffffff">Upload Images</a></li>
                </ul>
            </div>
        </div>
            ...
            <div class="isotope" style="position: relative; height: 10522.3px;">
                ...
                <div class="col one-four box illustration image-box" style="">
                    <figure class="thumb">
                        <a
                                href="#"
                                alt-src="../upload/dareDevil/<%=srcLists.get(i)%>"
                                data-large="../upload/dareDevil/<%=srcLists.get(i)%>"
                                data-large-size="1496x1800"
                                data-medium="../upload/dareDevil/<%=srcLists.get(i)%>"
                                data-medium-size="897.6x1080"
                                data-small="../upload/dareDevil/<%=srcLists.get(i)%>"
                                data-small-size="598.4x720">
                            <img
                                src="../upload/dareDevil/<%=srcLists.get(i)%>"
                                data-srcset="../upload/dareDevil/<%=srcLists.get(i)%> 960w, ../upload/dareDevil/<%=srcLists.get(i)%> 768w, ../upload/dareDevil/<%=srcLists.get(i)%> 480w"
                                alt-src="../upload/dareDevil/<%=srcLists.get(i)%>"
...
<div class="pswp" tabindex="-1" role="dialog" aria-hidden="true" style="background: #222222;color:#ffffff">
    ...
    <div class="pswp__scroll-wrap">
        ...
        <div class="pswp__ui pswp__ui--hidden container cf">
            ...
            <button tabindex="-1" style="color:#ffffff" class="large pswp__button pswp__button--arrow--left" title="⟨"></button>
            <button tabindex="-1" style="color:#ffffff" class="large pswp__button pswp__button--arrow--right" title="⟩"></button>
